...
--Все категории
Все категории при нажатие на которую попадаешь на книги относящиеся только к этой категории

--Все авторы
Все авторы остортированы по алфавиту и при нажатие на любого автора, переходим на книги, которые относятся только к нему

--Популярные книги
Популярные книги ограниченные count_review больше или равно 5
...
Есть проверка, что текущая книга не выводится второй раз
